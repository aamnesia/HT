require_relative 'route', 'station', 'train'
require_relative 'cargo_train', 'cargo_wagon'
require_relative 'pas_train', 'pas_wagon'
...
loop do
  ...
  case operation
  when 1 then operations.create_station
  when 2 then operations.create_train
  when 3 then operations.change_route
  when 4 then operations.follow_route
  when 5 then operations.hook_wagon
  when 6 then operations.unhook_wagon
  when 7 then operations.move_train
  when 8 then operations.show_stations_trains
  when 0 then break
  end
end
